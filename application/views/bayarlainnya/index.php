...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Transaksi Pembayaran Lainnya</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Transaksi</a></div>
                <div class="breadcrumb-item">Transaksi Pembayaran Lainnya</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-body mt-4">
                            <form action="<?= base_url('pembayaran/transaksispplainnya') ?>" method="get">
                                <div class="row">
