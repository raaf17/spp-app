...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Data SPP Lainnya</h4>
                    <div class="card-header-action">
                        <a href="<?= site_url('masterdata/add_sppmore') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                </div>
                <div class="card-body table-responsive">
                        ...
                        <tbody>
                            ...
                            foreach ($sppmore as $data) { ?>
                                <tr>
                                    ...
                                    <td><?= $data->NOMINAL; ?></td>
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#modalEditLain<?= $data->ID_SPP ?>" class="btn btn-sm btn-warning" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-md fa-pencil-alt text-white"></i></a>
                                        <a href="' . base_url('masterdata/spp_del/') .  $data->ID_SPP . '" class="btn btn-sm btn-danger tombol-hapus" id="delete" name="delete"><i class="fas fa-md fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<!-- Modal -->
<?php foreach ($spp as $p) : ?>
    <div class="modal fade" id="modalEditLain<?= $p->ID_SPP ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Data SPP Lainnya</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" action="<?= base_url('masterdata/sppmore_edit') ?>">
                    <input type="hidden" name="id_spp" value="<?= $p->ID_SPP ?>">

                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama_pembayaran">Nama Pembayaran</label>
                            <input type="number" class="form-control" id="nama_pembayaran" name="nama_pembayaran" value="<?= $p->NAMA_PEMBAYARAN ?>">
