    ...
    <div class="row">
      <div class="col-12 col-md-6 col-lg-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php base_url('pembayarantahunan/create') ?>" method="post">
              <?= csrf_field(); ?>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" id="table-1">
                ...
                <?php foreach ($pembayaran_data as $key => $value) { ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="" class="btn btn-success" data-toggle="modal" data-target="#modal-import-tahunan"><i class="fa-solid fa-dollar-sign" ></i></a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-import-tahunan">
